...
<body>
<div style="color: white; text-align: center; font-size: 30px;">Help Desk<i class='fas fa-comment-alt'></i></div>
<%
...
<%} %>
<form action="helpDeskAction.jsp" method="post">
<input class="input-style" name="subject" type="text" placeholder="subject" required>
<hr>
<textarea class="input-style" name="body" placeholder="Enter the Product Issues" required></textarea>
<hr>

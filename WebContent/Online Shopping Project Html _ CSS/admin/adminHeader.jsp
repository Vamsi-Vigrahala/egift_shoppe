...
<script src='https://kit.fontawesome.com/a076d05399.js'></script>
  ...
  <% String email= session.getAttribute("email").toString(); %>
            <center><h2>E Gift Shoppe</h2></center>
            ...
            <a href="updateStock.jsp">Update Stock <i class='fas fa-book'></i></a>
            <a href="feedbackReceived.jsp">Feedback Received <i class='fas fa-comment-alt'></i></a>
            <a href="helpRequest.jsp">Help Request Received <i class='fas fa-comment-alt'></i></a>

...
try
{
	Connection con=ConnectionProvider.getCon();
	   ...
	   ResultSet rs=st.executeQuery("select *from cart inner join product3 where cart.product_id=product3.id and cart.orderDate is not Null and cart.status='processing'");
	while(rs.next())
	{
...
<td><%=rs.getString(17) %><i class="fa fa-inr"></i><%=rs.getString(5) %> </td>

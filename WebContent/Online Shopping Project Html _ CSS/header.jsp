...
<script src='https://kit.fontawesome.com/a076d05399.js'></script>
    ...
    <%String email=session.getAttribute("email").toString();%>
            ...
            <a href="gift.jsp">Gifts<i class="fa fa-book"></i></a>
            ...
            <a href="feedback.jsp">Feedback <i class='fas fa-comment-alt'></i></a>
            <a href="helpDesk.jsp">HelpDesk <i class='fa fa-book'></i></a>
